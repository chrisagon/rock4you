...
// .wrangler/tmp/bundle-2oROme/strip-cf-connecting-ip-header.js
...
var init_hono_base = __esm({
  "node_modules/hono/dist/hono-base.js"() {
    ...
    Hono = /* @__PURE__ */ __name(class {
      ...
      request = (input, requestInit, Env7, executionCtx) => {
...
// .wrangler/tmp/bundle-2oROme/middleware-loader.entry.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// .wrangler/tmp/bundle-2oROme/middleware-insertion-facade.js
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
authRoutes.post("/login", zValidator("json", loginSchema), async (c) => {
  try {
    ...
    const userWithoutPassword = {
      ...
      derniere_connexion: (/* @__PURE__ */ new Date()).toISOString(),
      est_actif: true
    };
...
async function authLogger(c, next) {
  ...
  console.log(`[${(/* @__PURE__ */ new Date()).toISOString()}] ${method} ${path} - User: ${user ? `${user.prenom} ${user.nom} (${user.role})` : "anonymous"} - IP: ${ip}`);
  await next();
}
